package com.myits.newsapp.data.repository

import android.content.SharedPreferences
import com.myits.newsapp.data.dao.ResultDao
import com.myits.newsapp.data.mapper.toResult
import com.myits.newsapp.service.NewsService
...
class NewsRepository @Inject constructor(private val newsDao: ResultDao, private val newsService: NewsService, private val preferences: SharedPreferences) {
    ...
    private val languages = mapOf(
        Pair("id","indonesian"),Pair("en","english")
    )
