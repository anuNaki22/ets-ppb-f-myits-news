package com.myits.newsapp.ui.settings
...
fun SettingScreen(
    ...
    val languages = mapOf(
        Pair("id", "Bahasa Indonesia"),Pair("en","English")
    )
    ...
    var selectedText by remember {
        mutableStateOf(
            languages[preferences.getString(PREFERENCES_LANGUAGE, "id")] ?: "Bahasa Indonesia"
        )
    }
